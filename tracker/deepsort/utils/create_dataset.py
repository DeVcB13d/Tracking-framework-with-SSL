...
train = r"C:\Users\USER\tracking_dataset\ReID\train"
test = r"C:\Users\USER\tracking_dataset\ReID\test"
...
def create_data(gt_path,video_path,video_name,animals,train_step_frames = 20,test_step_frames = 81):
    # Storing the gt data as a list of lists
    # each entry would have the data for a frame
    # [frame][pigno] -> x1 y1 x2 y2
    gt_list = np.zeros((5000,animals+1,4))
    print(gt_path)
    ...
    # Train       
    for pigno in range(1,animals+1):
...
# videos_path = []
# gt_path = []
# names = ["MOT16-01","MOT16-03","MOT16-06","MOT16-08"]
# animals = [11,10,11,11]
# dataset_path = r"C:\Users\USER\tracking_dataset\gt\mot_challenge\MOT16-train"
...
# for video,gtf,vname,ano in zip(videos_path,gt_path,names,animals):
#     create_data(gtf,video,vname,ano)


video = r"C:\Users\USER\tracking_dataset\gt\mot_challenge\MOT16-train\MOT16-08\video\video.mkv"
gt = r"C:\Users\USER\tracking_dataset\gt\mot_challenge\MOT16-train\MOT16-08\gt\gt.txt"
vname = "MOT16-08"
ano = 11
create_data(gt,video,vname,ano)
